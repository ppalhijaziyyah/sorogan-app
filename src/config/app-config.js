...
export const appConfig = {
    ...
    defaultTextSettings: {
        ...
        accordionTitleSize: '18px',      // Ukuran teks judul "Penjelasan Tambahan" pada fitur lipatan
        accordionContentSize: '14px',    // Ukuran teks isi kandungan dalam fitur lipatan
